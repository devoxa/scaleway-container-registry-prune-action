...
;// CONCATENATED MODULE: ./src/scalewayApi.ts
...
function listTags(scwSecretToken, region, imageId) {
    return __awaiter(this, void 0, void 0, function* () {
...
function deleteTag(scwSecretToken, region, tagId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield lib_default()(`https://api.scaleway.com/registry/v1/regions/${region}/tags/${tagId}?${query}`, { method: 'DELETE', headers: { 'x-auth-token': scwSecretToken } });
        const json = yield response.json();
        if (json.id !== tagId) {
